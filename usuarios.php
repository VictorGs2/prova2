...
$data = "SELECT id, nome, login, senha FROM usuario";
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th scope="col"><a id="cadastrar" href="register.php?tipo=user">Usuário +</a></th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <?php if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) { ?>
                      ...
                      <td><a href="<?php echo "editpage.php?id=" . $row['id'] . "&nome=" . $row['nome'] . "&login=" . $row['login'] . "&senha=" . $row['senha'] . "&tipo=user" ?>"><button type="button" class="btn btn-primary">Editar</button></a>
                        <a href="deleteUser.php?id= <?php echo $row["id"]; ?>"><button type="button" class="btn btn-danger">Excluir</button></a></td>
                </tr>
            <?php }
                  } ?>
              </tbody>
